...
import { addToCart , increaseQuantity , decreaseQuantity , removeFromCart , EmptyCart } from '../../Redux/Slices/cartReducer';
    ...
    return(
        <div className="card">
           ...
           {!isCart && <div className="card-btns card-btns-wrapper">
            <button className="card-btn card-btn-wishlist"><ion-icon name="heart-outline"></ion-icon></button>
